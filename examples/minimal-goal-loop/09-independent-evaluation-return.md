...
| --- | ---: | --- | --- |
| MKR-1 | 1 | JSON CLI, schema, and determinism thresholds passed. | 08-independent-evaluation-report.md#mkr-results--mkr-结果 |
| MKR-2 | 1 | 12/12 text compatibility checks passed. | 08-independent-evaluation-report.md#mkr-results--mkr-结果 |
check_results:
...
| MKR-RESULTS | 1 | Both MKRs have binary results. | 08-independent-evaluation-report.md#mkr-results--mkr-结果 |
