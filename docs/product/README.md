...
Both profiles are current. Choose one profile per milestone and use the matching initializer.

两套配置都是当前正式配置。每个 milestone 选择一套，并使用对应初始化器。
