...
- This index cannot change a KR or milestone status.

Reviewer, when required, audits the current accepted artifacts listed here and the compact Orchestrator state against the original milestone contract.
