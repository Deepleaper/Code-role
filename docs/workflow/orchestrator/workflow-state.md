...
| Complete Project OKR accepted (0/1) | 0 |
| Complete KR table | none |
| Complete Product Contract accepted (0/1) | 0 |
| Accepted Product Contract | none |
...
| Current blocking contract | complete Project OKR |
...
- Product, Architecture, and Code Context pointers represent complete accepted global artifacts, not one-KR slices.
- Engineering owns STEP detail; do not duplicate `STEP-*` activity in this state.
...
- Only independent evidence can change a KR from `0` to `1`.
